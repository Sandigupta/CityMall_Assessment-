...
//       // Calculate stats from disasters
...
//         activeResources: Math.floor(disasters.length * 2.5), // Mock calculation
//         recentReports: Math.floor(disasters.length * 1.8) // Mock calculation
//       });
