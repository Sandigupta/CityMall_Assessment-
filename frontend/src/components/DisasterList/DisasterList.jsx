...
//     // Create CSV content
//     const csvHeaders = ['Title', 'Location', 'Description', 'Priority', 'Tags', 'Created Date', 'Owner'];
//     const csvData = selectedDisasters.map(disaster => [
//       disaster.title,
//       disaster.location_name || 'Unknown',
//       disaster.description?.replace(/"/g, '""') || '', // Escape quotes
...
//     try {
//       // Archive each selected disaster
...
// // Disaster Card Component for Grid View
// const DisasterCard = ({ 
//   disaster, 
//   index, 
//   selectedDisaster, 
...
// // Disaster Row Component for List View
// const DisasterRow = ({ 
//   disaster, 
//   index, 
//   selectedDisaster, 
